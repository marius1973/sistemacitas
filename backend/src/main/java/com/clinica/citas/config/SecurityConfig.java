        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/login", "/api/auth/registro",
                        "/api/auth/recuperar-contrasena", "/api/auth/restablecer-contrasena",
                        "/api/health", "/h2-console/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/auth/registro-staff").hasRole("ADMINISTRADOR")
                ...
                .requestMatchers(HttpMethod.GET, "/api/medicos/**")
                    .hasAnyRole("PACIENTE", "RECEPCIONISTA", "ADMINISTRADOR", "MEDICO")
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/medicos/**").hasRole("ADMINISTRADOR")
