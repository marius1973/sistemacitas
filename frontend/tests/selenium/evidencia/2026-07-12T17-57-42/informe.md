...
| Fecha de ejecución | 2026-07-12T17:57:42.585Z → 2026-07-12T17:58:42.771Z |
| Ejecutor | MarioADM |
...
|---|---|---|---|---|---|---|
| CP01 | RF01 | Registro exitoso de paciente | UI (Selenium) | **APROBADO** | 6848 ms | [captura](capturas/CP01_resultado.png) |
| CP02 | RF02 | Inicio de sesión con credenciales inválidas | UI (Selenium) | **APROBADO** | 4004 ms | [captura](capturas/CP02_resultado.png) |
| CP03 | RF03 | Listado de especialidades existentes | UI (Selenium) | **APROBADO** | 5056 ms | [captura](capturas/CP03_resultado.png) |
| CP04 | RF04 | Consulta de disponibilidad sin bloques configurados | UI (Selenium) + API | **OBSERVADO** | 11169 ms | [captura](capturas/CP04_resultado.png) |
| CP05 | RF05 | Reserva de cita en horario disponible | UI (Selenium) | **APROBADO** | 7444 ms | [captura](capturas/CP05_resultado.png) |
| CP06 | RF05, RNF05 | Intento de reserva simultánea sobre el mismo horario | API (doble sesión) | **APROBADO** | 4311 ms | — |
| CP07 | RF06 | Cancelación de una cita pendiente | UI (Selenium) | **APROBADO** | 6101 ms | [captura](capturas/CP07_resultado.png) |
| CP08 | RF07 | Reprogramación a un horario fuera de disponibilidad | UI (Selenium) + API | **APROBADO** | 10128 ms | [captura](capturas/CP08_resultado.png) |
...
- **Resultado obtenido:** APROBADO — Simultáneo 2026-07-13 11:00:00: HTTP 200/409 → aceptadas=1
